...
<section class="shell py-14 lg:py-20">
  <div class="max-w-3xl">
    ...
    <h1 class="mt-4 text-5xl font-semibold tracking-tight text-textPrimary">Engineering notes, architecture deep-dives, and implementation journals.</h1>
    <p class="mt-5 text-lg leading-8 text-textSecondary">Writing about practical systems: Rails architecture, AI orchestration, deterministic workflows, validation, schema-aware tooling, and the process of building SeederKit.</p>
  </div>
  ...
  <div class="mt-8 overflow-hidden rounded-2xl border border-line bg-surface/60">
    ...
    {% else %}
      <div class="p-8">
        ...
        <p class="mt-3 max-w-2xl leading-7 text-textSecondary">The first set should document SeederKit’s origin, schema reader, deterministic orchestration model, scenario DSL, and Rails domain graph builder.</p>
      </div>
    {% endfor %}
  </div>
</section>
